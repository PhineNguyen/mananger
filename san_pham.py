...
def create_san_pham_tab(notebook):
    ...
    canvas2 = tk.Canvas(tab, bg="#B1C6B4", width=515, height=835+205)
    canvas2.config(bg="#B1C6B4")
    canvas2.place(x=1400, y=0)

    canvas3 = tk.Canvas(tab, bg="#B1C6B4", width=1390, height=835+205)
    canvas3.config(bg="#B1C6B4")
    canvas3.place(x=4, y=0)
